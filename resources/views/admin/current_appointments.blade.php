         	...
         	<div align="center" style="padding-top:100px;">
         		<table>
         			<tr style="background-color:black;">
         				...
         				<th style="padding:10px;">Coach's Name</th>
         			...
         			<tr align="center" style="background-color:skyblue;">
         				...
         				<td>
         					<a class="btn btn-danger" href="{{url('cancelled',$data->id)}}">Cancel</a>
         				</td>
         				<td>
         					<a class="btn btn-primary" href="{{url('sendemail',$data->id)}}">Send Mail</a>
         				</td>
         			</tr>
