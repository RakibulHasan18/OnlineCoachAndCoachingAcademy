         	...
         	<div align="center" style="padding-top:100px;">
         		...
         		<tr style="background-color:black;">
         			...
         			<tr align="center" style="background-color:skyblue;">
         				...
         				<td>{{$data->time}}</td>
         				<td>
         					<img height="100" width="100" src="coachimage/{{$data->image}}">
         				</td>

         				<td>
         					<a onclick="return confirm('Are you sure to delete this?')" class="btn btn-danger" href="{{url('deletecoach',$data->id)}}">Delete</a>
         				</td>
         				<td>
         					<a class="btn btn-primary" href="{{url('updatecoach',$data->id)}}">Update</a>
         				</td>
