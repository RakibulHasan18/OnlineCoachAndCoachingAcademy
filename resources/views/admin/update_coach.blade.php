    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
          ...
          @endif
      		...
      		<form action="{{url('editcoach',$data->id)}}" method="POST" enctype="multipart/form-data">
      			...
      			<div style="padding: 15px;">
      				<label>Age</label>
      				<input type="text" style="color:black" name="time"value="{{$data->time}}">
      				

      			</div>
      			<div style="padding: 15px;">
      				<label>Current Image</label>
      				<img height="150" width="150" src="coachimage/{{$data->image}}">
