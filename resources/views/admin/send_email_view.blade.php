    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="container" align="center" style="padding-top: 100px;">
          ...
          <form action="{{url('emailnotify',$data->id)}}" method="POST">
            ...
            <input type="text" style="color:black" name="additionaltext" required="">

            </div>
            <div style="padding: 15px;">

            <label>Meet link</label>
            <input type="text" style="color:black" name="meetlink" required="">

            </div>
            <div style="padding: 15px;">

            <label>Ending</label>
            <input type="text" style="color:black" name="ending" required="">
