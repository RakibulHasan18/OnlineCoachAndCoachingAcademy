    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="container" align="center" style="padding-top: 100px;">
          ...
          <form action="{{url('upload_coach')}}" method="POST" enctype="multipart/form-data">

            @csrf
            <div style="padding: 15px;">

            <label>Coach Name</label>
            <input type="text" style="color:black" name="name" palceholder="Write the name" required="">

            </div>
            <div style="padding: 15px;">

            <label>Phone</label>
            <input type="text" style="color:black" name="number" palceholder="Write the number" required="">
            ...
            <label>Age</label>
            <input type="text" style="color:black" name="time" palceholder="Write the time" required="">
